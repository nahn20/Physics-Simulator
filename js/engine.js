...
function startEngine(){
	...
	sim.entities.push(new spring(sim.entities[sim.entities.length-1],90,300,20, 50, {sticky: true}))

	sim.entities.push(new basicRectangle([320,580], [60,20], {gravity:false,infiniteMass:true}));
	sim.entities.push(new spring(sim.entities[sim.entities.length-1],90,300,20, 100, {sticky: true}))
